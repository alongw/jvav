...
<template>
  <div class="main">
    <div class="macos"><a href="javascript:;">某些使用 macOS 的 Jvav 8 用户需要手动更新</a></div>
    <div class="download">
      <div class="left">
  ...
  <div class="jdk">
    <div class="tips"><h3>您是要寻找 JDK 下载的软件开发人员吗？</h3></div>
    <div class="btng">
      <button>CloseJDK Early Access 工作版本</button>
      <button>Jvav SE 开发工具包</button>
    </div>
  </div>
</template>
